...
public abstract class SettingsMachines<DataTree> {
	...
	abstract public VBox DisplayPopUp();
	...
	public void PopUp() {
	    ...
	    VBox display = DisplayPopUp();
	    
	    Vbox_general.getChildren().add(display);
	...
	public Node buttonConfirm() {
		...
		create.setOnAction(ActionEvent -> {
			setValid(true);
			PopupWindow.hide();
			//dataTree.addProcedure(getTitle(), isValid());
	...
	public void setValid(boolean responce) { this.procedureValid = responce; }
	public boolean isValid() { return procedureValid; }
